            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h3>Financial Analysis Services</h3>
                        <ul>
            ...
            <div class="col-lg-8 col-md-7">
                <div class="services-details">
                    ...
                    <div class="services-details-content">
                        ...
                        <p>Financial Ratios Analysis is a way of determining the health of a business. Just as a doctor
                            might take your pulse, temperature and blood pressure to give information on your health, we
                            use Financial Ratios Analysis to identify weaknesses of your business.</p>
                        <br>
                        <p>Financial Ratios Analysis is an important tool for small business owners to measure progress
                            toward reaching their business goals, as well as toward competing in the market. Financial
                            Ratios Analysis is a useful tool that will provide key indicators of your business
                            performance. Business owners use Financial Ratios Analysis to identify weaknesses from which
                            corrective action can be taken.</p>
                        <br>

                        <p>The ratios presented below represent some of the standard ratios used in business practice.
                            We can also develop your own ratios and indicators based on what you consider important and
                            meaningful to your business and industry:</p>

                        <div class="services-details-features">
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <ul>
                                        <li><i class="fa fa-check"></i> Operational Efficiency Ratios - How efficiently
                                            are you utilizing your assets and managing your liabilities?</li>
                                        <li><i class="fa fa-check"></i> Profitability Ratios - How well is your business
                                            performing over a specific period?</li>
                                        <li><i class="fa fa-check"></i> Liquidity Ratios - Does your business have
                                            enough cash on an ongoing basis to meet its operational obligations?</li>
