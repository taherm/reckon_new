    ...
    <div class="services-details-features">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <ul>
                    <li><i class="fa fa-check"></i> @lang('general.financial_planning_service.list1')</li>
                    <li><i class="fa fa-check"></i>@lang('general.financial_planning_service.list2')</li>
                    <li><i class="fa fa-check"></i>@lang('general.financial_planning_service.list3')
                    </li>
                    <li><i class="fa fa-check"></i> @lang('general.financial_planning_service.list4')</li>
                </ul>
            </div>
